<?php
/*
Template Name: LiveFot API Subscription
*/
?>
<!DOCTYPE html>
...
<head>
  ...
  <title>LiveFot API Subscription</title>
...
<div class="livefoot-container">
  <div class="livefoot-header">
    <div class="livefoot-logo">
      ...
      <h1>LiveFot<span>API</span></h1>
    </div>
    <p class="livefoot-tagline">Professional Football Data API for Developers and Businesses</p>
    <div class="livefoot-version">WordPress Plugin: LiveFot Matches v1.0</div>
  </div>

  <div class="subscription-section">
    <h2>Select Your Yearly Subscription Based on Leagues</h2>
  <p class="subscription-description"> Unlock unparalleled performance with our premium API, engineered for speed and reliability. Enjoy up to <strong>2,000 calls per endpoint per hour</strong>, dedicated <strong>email support</strong>, and comprehensive <strong>Live Match Updates</strong> for major leagues worldwide. Our expert team diligently monitors live matches and provides instantaneous livescore updates, ensuring you stay ahead in the game – all powered by the advanced LiveFot App. </p>

    <div class="subscription-plans">
      <!-- 25 Leagues Plan -->
      <div class="plan-card blue-plan">
      ...
      <!-- 40 Leagues Plan -->
      <div class="plan-card green-plan">
        <div class="plan-header">
          <h3>40 Leagues</h3>
          <div class="plan-price">
            <span class="currency">$</span>
      ...
      <!-- 55 Leagues Plan -->
      <div class="plan-card purple-plan">
        <div class="plan-header">
          <h3>55 Leagues</h3>
          <div class="plan-price">
            <span class="currency">$</span>
    ...
    <div class="login-redirect-container">
      <div class="login-redirect-card">
        ...
        <p>Login or create an account to select your subscription plan and proceed with payment.</p>
        <a href="<?php echo site_url('/login-page'); ?>" class="login-button">
    ...
    <!-- Demo Button -->
    <div class="demo-redirect-container">
      <div class="demo-redirect-card">
        <h3>View Plugin Demo</h3>
        <p>Experience the plugin demo on our Matches page.</p>
        <a href="<?php echo site_url('/matches'); ?>" class="demo-button">
          View Demo
        </a>
      </div>
    </div>
  ...
  <div class="livefoot-features">
    ...
    <div class="features-grid">
      ...
      <div class="feature-card">
        ...
        <p>All match times and dates are automatically converted to the user's local timezone without any manual configuration.</p>
      </div>
      <div class="feature-card">
        <div class="feature-icon">
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" 
  ...
  <div class="livefoot-plugin-info">
    <h2>WordPress Plugin: LiveFot Matches v1.0</h2>
  ...
  <div class="livefoot-footer">
    <div class="footer-content">
      <div class="footer-logo">
        ...
        <h3>LiveFot<span>API</span></h3>
     </div>
        <p>© <?php echo date('Y'); ?> LiveFot API. All rights reserved.</p>
        <p>For inquiries or support, email us at <a href="mailto:info@livefootballcenter.com" style="color: gray;">info@livefootballcenter.com</a>.</p>
