...
if (!class_exists('CoverNews_Posts_Slider')) :
    ...
    class CoverNews_Posts_Slider extends AFthemes_Widget_Base
    {
        ...
        {
            $this->text_fields = array('covernews-posts-slider-title', 'covernews-excerpt-length', 'covernews-posts-slider-number');
        ...
        public function widget($args, $instance)
        {
            ...
            $number_of_posts = !empty($instance['covernews-posts-slider-number']) ? $instance['covernews-posts-slider-number'] : 5;
        ...
        public function form($instance)
        {
            ...
            if (isset($categories) && !empty($categories)) {
                ...
                echo parent::covernews_generate_text_input('covernews-posts-slider-number', __('Number of Posts', 'covernews'), '5', 'number');
