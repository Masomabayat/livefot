...
if (!class_exists('CoverNews_Tabbed_Posts')) :
    ...
    class CoverNews_Tabbed_Posts extends AFthemes_Widget_Base
    {
        ...
        {
            $this->text_fields = array('covernews-tabbed-popular-posts-title', 'covernews-tabbed-latest-posts-title', 'covernews-tabbed-categorised-posts-title', 'covernews-excerpt-length', 'covernews-posts-number');
        ...
        public function widget($args, $instance)
        {
            ...
            $excerpt_length = !empty($instance['covernews-excerpt-length']) ? $instance['covernews-excerpt-length'] : '20';
        ...
        public function form($instance)
        {
            ...
            echo parent::covernews_generate_text_input('covernews-excerpt-length', __('Excerpt length', 'covernews'), '25');
            echo parent::covernews_generate_text_input('covernews-posts-number', __('Number of posts per tab', 'covernews'), '5');
