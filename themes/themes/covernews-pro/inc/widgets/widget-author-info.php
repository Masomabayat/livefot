...
if (!class_exists('CoverNews_author_info')) :
    ...
    class CoverNews_author_info extends AFthemes_Widget_Base
    {
        ...
        function __construct()
        {
            ...
            $this->url_fields = array('covernews-author-info-facebook', 'covernews-author-info-twitter', 'covernews-author-info-linkedin', 'covernews-author-info-instagram', 'covernews-author-info-vk', 'covernews-author-info-youtube' );
        ...
        public function widget($args, $instance)
        {
            ...
            $instagram = !empty($instance['covernews-author-info-instagram']) ? ($instance['covernews-author-info-instagram']) : '';
            $vk = !empty($instance['covernews-author-info-vk']) ? ($instance['covernews-author-info-vk']) : '';
            $youtube = !empty($instance['covernews-author-info-youtube']) ? ($instance['covernews-author-info-youtube']) : '';
                    ...
                    <?php if (!empty($facebook) || !empty($twitter) || !empty($linkedin)) : ?>
                        <ul>
                            ...
                            <?php if (!empty($youtube)) : ?>
                                <li>
                                    <a href="<?php echo esc_url($youtube); ?>" target="_blank"><i
        ...
        public function form($instance)
        {
            ...
            if (isset($categories) && !empty($categories)) {
                ...
                echo parent::covernews_generate_text_input('covernews-author-info-title', __('About Author', 'covernews'), __('Title', 'covernews'));
                ...
                echo parent::covernews_generate_text_input('covernews-author-info-instagram', __('Instagram', 'covernews'), '');
                echo parent::covernews_generate_text_input('covernews-author-info-youtube', __('Youtube', 'covernews'), '');
                echo parent::covernews_generate_text_input('covernews-author-info-vk', __('VK', 'covernews'), '');
