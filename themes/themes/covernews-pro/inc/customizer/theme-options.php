...
// Setting - global content alignment of news.
$wp_customize->add_setting('sticky_header_direction',
    array(
        'default'           => $default['sticky_header_direction'],
        'capability'        => 'edit_theme_options',
        'sanitize_callback' => 'covernews_sanitize_select',
    )
);

$wp_customize->add_control( 'sticky_header_direction',
    array(
        'label'       => esc_html__('Sticky Header Direction', 'covernews'),
        'description' => esc_html__('Select sticky header direction', 'covernews'),
        'section'     => 'header_options_settings',
        'type'        => 'select',
        'choices'               => array(
            'scrollup-sticky-header' => esc_html__( 'Scroll Up', 'covernews' ),
            'scrolldown-sticky-header' => esc_html__( 'Scroll Down', 'covernews' ),
            'scrollboth-sticky-header' => esc_html__( 'Both Scroll', 'covernews' )

        ),
        'priority'    => 11,
        'active_callback' => 'covernews_sticky_header_status'
    ));
...
$wp_customize->add_control( 'archive_layout',
    array(
        ...
        'type'        => 'select',
        'choices'               => array(
            'archive-layout-full' => esc_html__( 'Full - Default', 'covernews' ),
            'archive-layout-full-2' => esc_html__( 'Full - Title First', 'covernews' ),
            'archive-layout-grid' => esc_html__( 'Grid - Default', 'covernews' ),
            'archive-layout-grid-2' => esc_html__( 'Grid - Double Column', 'covernews' ),
...
// Setting number_of_footer_widget.
$wp_customize->add_setting('instagram_access_token_type',
    array(
        'default'           => $default['instagram_access_token_type'],
        'capability'        => 'edit_theme_options',
        'sanitize_callback' => 'covernews_sanitize_select',
    )
);
...
$wp_customize->add_control('instagram_access_token_type',
    array(
        'label'    => esc_html__('Access Token Type:', 'covernews'),
        'section'  => 'site_footer_instagram_settings',
        'type'     => 'select',
        'priority' => 100,
        'choices'  => array(
            'graphapi' => esc_html__('New (Graph API)', 'covernews'),
            'instaapi'        => esc_html__('Old (Instagram API)', 'covernews'),
        ),
        'active_callback' => 'covernews_footer_instagram_posts_status',
    )
);
...
// Setting - instagram username of news.
$wp_customize->add_setting('instagram_access_token_graphapi',
    array(
        'default'           => $default['instagram_access_token_graphapi'],
        'capability'        => 'edit_theme_options',
        'sanitize_callback' => 'sanitize_text_field',
    )
);

$wp_customize->add_control( 'instagram_access_token_graphapi',
    array(
        'label'    => __( 'Graph API Access Token', 'covernews' ),
        'description' => esc_html__('Please use your instagram app access token if you aleady have, Otherwise create new: "https://developers.facebook.com/docs/instagram-api/".', 'covernews'),
        'section'  => 'site_footer_instagram_settings',
        'type'     => 'text',
        'priority' => 100,
        'active_callback' => function( $control ) {
            return (
                covernews_footer_instagram_posts_status( $control )
                &&
                covernews_footer_instagram_posts_status_graphapi( $control )
            );
        },
    )
);
...
$wp_customize->add_control( 'instagram_access_token',
    array(
        'label'    => __( 'Instagram Access Token (Old)', 'covernews' ),
        ...
        'active_callback' => function( $control ) {
            return (
                covernews_footer_instagram_posts_status( $control )
                &&
                covernews_footer_instagram_posts_status_instaapi( $control )
            );
        },
    )
);
