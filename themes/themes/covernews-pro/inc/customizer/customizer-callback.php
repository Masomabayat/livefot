...
if ( ! function_exists( 'covernews_global_site_mode_status' ) ) :
     ...
     */
    function covernews_global_site_mode_status( $control ) {
...
if ( ! function_exists( 'covernews_flash_posts_section_status' ) ) :
    ...
    /*select page for slider*/
if ( ! function_exists( 'covernews_main_navigation_background_color_mode_status' ) ) :
     ...
     * @return bool Whether the control is active to the current preview.
     */
    function covernews_main_navigation_background_color_mode_status( $control ) {
...
/*select page for slider*/
if ( ! function_exists( 'covernews_main_banner_section_order_2_status' ) ) :
     ...
     * @return bool Whether the control is active to the current preview.
     */
    function covernews_main_banner_section_order_2_status( $control ) {
...
if ( ! function_exists( 'covernews_banner_mode_status' ) ) :
    ...
    function covernews_banner_mode_status( $control ) {
        ...
        if ( ('slider-editors-picks-trending' == $control->manager->get_setting( 'select_main_banner_section_mode' )->value()) || ('slider-trending' == $control->manager->get_setting( 'select_main_banner_section_mode' )->value())) {
            return true;
        } else {
            return false;
        }
    ...
    /*select page for slider*/
if ( ! function_exists( 'covernews_banner_mode_editor_picks_status' ) ) :
     ...
     * @return bool Whether the control is active to the current preview.
     */
    function covernews_banner_mode_editor_picks_status( $control ) {

        if ( ('slider-editors-picks-trending' == $control->manager->get_setting( 'select_main_banner_section_mode' )->value()) || ('slider-editors-picks' == $control->manager->get_setting( 'select_main_banner_section_mode' )->value())) {
            return true;
        } else {
            return false;
        }
...
/*select page for slider*/
if ( ! function_exists( 'covernews_footer_instagram_posts_status_graphapi' ) ) :
     ...
     * @return bool Whether the control is active to the current preview.
     */
    function covernews_footer_instagram_posts_status_graphapi( $control ) {

        if ( 'graphapi' == $control->manager->get_setting( 'instagram_access_token_type' )->value() ) {
            return true;
        } else {
            return false;
        }
...
/*select page for slider*/
if ( ! function_exists( 'covernews_footer_instagram_posts_status_instaapi' ) ) :
     ...
     * @return bool Whether the control is active to the current preview.
     */
    function covernews_footer_instagram_posts_status_instaapi( $control ) {

        if ( 'instaapi' == $control->manager->get_setting( 'instagram_access_token_type' )->value() ) {
            return true;
        } else {
            return false;
        }
