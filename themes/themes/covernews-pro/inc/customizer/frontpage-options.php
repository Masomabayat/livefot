...
$wp_customize->add_control( 'select_flash_new_mode',
    array(
        ...
        'choices'               => array(
            ...
            'flash-slide-right' => esc_html__( "Slide Left to Right", 'covernews' ),
...
$wp_customize->add_control( 'select_main_banner_section_order_1',
    array(
        ...
        'choices'               => array(
            ...
            'order-3' => esc_html__( "Order 3", 'covernews' ),
        ),
        'priority'    => 23,
        'active_callback' => function( $control ) {
            return (
                ...
                &&
                covernews_main_banner_section_order_1_status( $control )
            );
        },
    ));

// Setting - select_main_banner_section_mode.
$wp_customize->add_setting('select_main_banner_section_order_2',
    array(
        'default'           => $default['select_main_banner_section_order_2'],
        'capability'        => 'edit_theme_options',
        'sanitize_callback' => 'covernews_sanitize_select',
    )
);

$wp_customize->add_control( 'select_main_banner_section_order_2',
    array(
        'label'       => esc_html__('Banner Section Order', 'covernews'),
        'description' => esc_html__('Select Banner Section Order', 'covernews'),
        'section'     => 'frontpage_main_banner_section_settings',
        ...
        'active_callback' => function( $control ) {
            return (
                covernews_main_banner_section_status( $control )
                &&
                covernews_main_banner_section_order_2_status( $control )
            );
        },
    ));
...
//section title
$wp_customize->add_setting('main_news_slider_panel_title',
    array(
        'sanitize_callback' => 'sanitize_text_field',
    )
);
...
$wp_customize->add_control(
    new CoverNews_Section_Title(
        $wp_customize,
        'main_news_slider_panel_title',
        array(
            'label' => esc_html__('Main News Section', 'covernews'),
            'section' => 'frontpage_main_banner_section_settings',
            'priority' => 23,
            'active_callback' => 'covernews_main_banner_section_status'
        )
...
//section title
$wp_customize->add_setting('editors_picks_panel_title',
    array(
        'sanitize_callback' => 'sanitize_text_field',
    )
);
...
$wp_customize->add_control(
    new CoverNews_Section_Title(
        $wp_customize,
        'editors_picks_panel_title',
        array(
            'label' => esc_html__("Editor's Picks", 'covernews'),
            'section' => 'frontpage_main_banner_section_settings',
            'priority' => 23,
            'active_callback' => function( $control ) {
                return (
...
// Setting - select_main_banner_section_mode.
$wp_customize->add_setting('select_editors_picks_number',
    array(
        'default'           => $default['select_editors_picks_number'],
        'capability'        => 'edit_theme_options',
        'sanitize_callback' => 'covernews_sanitize_select',
    )
);

$wp_customize->add_control( 'select_editors_picks_number',
    array(
        'label'       => esc_html__("No. of Editor's Picks Thumbs", 'covernews'),
        'section'     => 'frontpage_main_banner_section_settings',
        'type'        => 'select',
        'choices'               => array(
            'slider-with-4-editors-picks' => esc_html__( "4 Thumbs", 'covernews' ),
            'slider-with-3-editors-picks' => esc_html__( "3 Thumbs", 'covernews' ),
            'slider-with-2-editors-picks' => esc_html__( "2 Thumbs", 'covernews' ),
        ),
        'priority'    => 23,
        'active_callback' => function( $control ) {
            return (
...
//section title
$wp_customize->add_setting('trending_slider_panel_title',
    array(
        'sanitize_callback' => 'sanitize_text_field',
    )
);
...
$wp_customize->add_control(
    new CoverNews_Section_Title(
        $wp_customize,
        'trending_slider_panel_title',
        array(
            'label' => esc_html__("Trending Slider Section", 'covernews'),
            'section' => 'frontpage_main_banner_section_settings',
            'priority' => 23,
            'active_callback' => function( $control ) {
                return (
