    ...
    function covernews_front_page_main_section_3()
    {
        ...
        <section class="af-blocks">
            <?php if ($covernews_enable_main_slider): ?>
                <div class="container af-main-banner main-banner-3rd default-section-slider aft-banner-3 <?php echo esc_attr($covernews_main_banner_section_order_2); ?>">
                    <div class="row">
                        ...
                        <div class="for-main-row">
                                ...
                                <div class="main-slider full-slider-mode">
                                    ...
                                    if ($slider_posts->have_posts()) :
                                        while ($slider_posts->have_posts()) : $slider_posts->the_post();
                                            ...
                                            global $post;
                                            $thumbnail_size ='covernews-slider-full'
                                            ?>
                            ...
                            ?>
                            <div id="aft-trending-story-five" class="trending-story col-sm-4">
