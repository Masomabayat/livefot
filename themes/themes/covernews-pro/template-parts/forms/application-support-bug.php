...
<form id="appBug" class="tabs-block__form application-support__form-bug">
    <input type="hidden" name="action" value="submit_support_form">
    <input type="hidden" name="subject" value="Feedback and bug reporting">
    ...
    <input class="user-country tabs-block__form-country" name="user-country" type="text" placeholder="<?php echo get_field('placeholder_country', 'option'); ?>">
