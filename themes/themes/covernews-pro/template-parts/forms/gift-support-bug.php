...
<form id="giftBug" class="tabs-block__form gift-support__form-bug">
    <input type="hidden" name="action" value="submit_support_form">
    <input type="hidden" name="subject" value="Report a bug">
    <input name="user-name" class="tabs-block__form-name" type="text" placeholder="<?php echo get_field('placeholder_name', 'option'); ?>">
