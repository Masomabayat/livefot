		...
		<?php else : ?>
			<div class="anwp-b-wrap anwpfl-match-metabox-wrapper">
				...
				<script type="text/javascript">
					var _anwp_FL_MatchSetup_Competitions = <?php echo wp_json_encode( anwp_fl()->competition->get_competitions() ); ?>;
				</script>
	...
	public function save_metabox( int $post_id ): int {
		...
		if ( 'setup' === $game_save_mode ) {
			...
			*/
			...
			if ( ! $game_data['main_stage_id'] && 'secondary' === get_post_meta( $game_data['competition_id'], '_anwpfl_multistage', true ) ) {
			...
			*/
			...
			$data['kickoff']  = $this->plugin->helper->validate_date( $data['kickoff'] ) ? $data['kickoff'] : '0000-00-00 00:00:00';
