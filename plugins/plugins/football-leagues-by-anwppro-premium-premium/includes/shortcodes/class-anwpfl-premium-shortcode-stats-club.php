<?php
/**
 * AnWP Football Leagues Premium :: Shortcode > Stats Club
 *
 * @since   0.12.4
 ...
 * AnWP Football Leagues Premium :: Shortcode > Stats Club.
 */
class AnWPFL_Premium_Shortcode_Stats_Club {

	private $shortcode = 'anwpfl-stats-club';
	...
	public function hooks() {
		...
		// Load shortcode form
		add_action( 'anwpfl/shortcode-pro/get_shortcode_form_stats-club', [ $this, 'load_shortcode_form' ] );
	}
	...
	public function load_shortcode_form() {
		...
		<input type="hidden" class="fl-shortcode-name" name="fl-slug" value="anwpfl-stats-club">
		<?php
	}
	...
	public function add_shortcode_option( $data ) {
		...
		$data['stats-club'] = __( 'Club Stats', 'anwp-football-leagues-premium' );
	...
	public function render_shortcode( $atts ) {
		...
		return anwp_football_leagues()->template->shortcode_loader( 'premium-stats-club', $atts );
	}
}

// Bump
new AnWPFL_Premium_Shortcode_Stats_Club();
