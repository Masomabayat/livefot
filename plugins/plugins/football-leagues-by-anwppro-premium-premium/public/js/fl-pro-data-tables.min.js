 ...
 *   https://datatables.net/download/#dt/dt-1.12.1/b-2.2.3/b-colvis-2.2.3/fc-4.1.0
 *
 * Included libraries:
 *   DataTables 1.12.1, Buttons 2.2.3, Column visibility 2.2.3, FixedColumns 4.1.0
 */
...
a,d=this.aiDisplay.length,e=this.oFeatures,h=e.bPaginate;return e.bServerSide?!1===h||-1===a?b+d:Math.min(b+a,this._iRecordsDisplay):!h||c>d||-1===a?d:c},oInstance:null,sInstance:null,iTabIndex:0,nScrollHead:null,nScrollFoot:null,aLastSort:[],oPlugins:{},rowIdFn:null,rowId:null};u.ext=M={buttons:{},classes:{},build:"dt/dt-1.12.1/b-2.2.3/b-colvis-2.2.3/fc-4.1.0",errMode:"alert",feature:[],search:[],selector:{cell:[],column:[],row:[]},internal:{},legacy:{ajax:null},pager:{},renderer:{pageButton:{},header:{}},order:{},type:{detect:[],
...
window.anwpFLProDataTables={},function(window,$,app){const l10n=window.anwpfl_premium_public_l10n||{};app.init=function(){"loading"!==document.readyState?app.initMethods():document.addEventListener("DOMContentLoaded",app.initMethods)},app.initMethods=function(){$.fn.dataTable&&setTimeout(()=>{$.fn.dataTable.tables({visible:!0,api:!0}).columns.adjust()},0),app.initRefereesStats(),app.initDataStatsClubs(),app.initDataStatsPlayers(),app.resizeObserver()},app.initRefereesStats=function(){document.body.contains(document.querySelector(".anwp-data-shortcode-referees-stats"))&&void 0!==$.fn.dataTable&&Array.from(document.querySelectorAll(".anwp-data-shortcode-referees-stats")).forEach(el=>{let tableOrder=[];if(el.dataset.flOrder)try{tableOrder=JSON.parse(el.dataset.flOrder)}catch(e){console.log(e),tableOrder=[]}var tableArgs={scrollX:!0,paging:!1,searching:!1,info:!1,order:tableOrder,columnDefs:[{targets:"no-sort",orderable:!1}],fixedColumns:{leftColumns:1},language:{emptyTable:"No data"}};$(el).DataTable(tableArgs)})},app.initDataStatsClubs=function(){document.body.contains(document.querySelector(".anwp-data-shortcode-stats_clubs_custom"))&&void 0!==$.fn.dataTable&&Array.from(document.querySelectorAll(".anwp-data-shortcode-stats_clubs_custom")).forEach(el=>{$(el).DataTable({scrollX:!0,paging:!1,searching:!1,info:!1,order:[],columnDefs:[{targets:"no-sort",orderable:!1}],fixedColumns:{leftColumns:1},language:{emptyTable:"No data"}})})},app.initDataStatsPlayers=function(){if(void 0===$.fn.dataTable)return!1;document.body.contains(document.querySelector(".anwp-fl-match-player-stats"))&&Array.from(document.querySelectorAll(".anwp-fl-match-player-stats")).forEach(el=>{$(el).DataTable({scrollX:!0,paging:!1,searching:!1,info:!1,order:[],columnDefs:[{targets:"no-sort",orderable:!1}],fixedColumns:{leftColumns:1},language:{emptyTable:"No data"}})}),document.body.contains(document.querySelector(".anwp-data-shortcode-stats_players"))&&Array.from(document.querySelectorAll(".anwp-data-shortcode-stats_players")).forEach(el=>{const tableArgs={scrollX:!0,dom:"Bfrtip",buttons:[{extend:"colvis",columnText:function(dt,idx){return $(dt.column(idx).header()).attr("title")||$(dt.column(idx).header()).attr("data-original-title")}}],pageLength:Number(el.dataset.rows),fixedColumns:{leftColumns:1},language:{processing:l10n.processing,search:l10n.search,lengthMenu:l10n.lengthMenu,info:l10n.info,infoEmpty:l10n.infoEmpty,infoFiltered:l10n.infoFiltered,infoPostFix:l10n.infoPostFix,loadingRecords:l10n.loadingRecords,zeroRecords:l10n.zeroRecords,emptyTable:l10n.emptyTable,paginate:{first:l10n.paginate_first,previous:l10n.paginate_previous,next:l10n.paginate_next,last:l10n.paginate_last},aria:{sortAscending:l10n.aria_sortAscending,sortDescending:l10n.aria_sortDescending},buttons:{colvis:l10n.colvis,pageLength:{_:l10n.show__rows,"-1":l10n.show_all}}},initComplete:function(){this.api().columns().every(function(){const column=this;if($(column.header()).data("filter")){const select=$("<select />").appendTo(column.footer()).on("change",function(){var val=$.fn.dataTable.util.escapeRegex($(this).val());column.search(val?"^"+val+"$":"",!0,!1).draw()});select.append('<option value=""></option>'),column.data().unique().sort().each(function(d){-1===d.indexOf(";")&&select.append('<option value="'+d+'">'+d+"</option>")})}})}};el.dataset.paging?(tableArgs.buttons.unshift("pageLength"),tableArgs.lengthMenu=[[10,25,50,-1],[l10n.rows_10,l10n.rows_25,l10n.rows_50,l10n.show_all]]):(tableArgs.pageLength=-1,tableArgs.paging=!1),"json"===el.dataset.flSource&&(tableArgs.data=window[el.dataset.flSourceId]),$(el).DataTable(tableArgs)})},app.resizeObserver=function(){if(window.ResizeObserver){const observer=new ResizeObserver(entries=>{entries.forEach(()=>{$.fn.dataTable.tables({visible:!0,api:!0}).columns.adjust()})});Array.from(document.querySelectorAll(".anwp-fl-data-tables")).forEach(el=>{observer.observe(el)})}},app.init()}(window,jQuery,window.anwpFLProDataTables);