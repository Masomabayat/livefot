...
$show_event_minutes = 'hide' !== anwp_football_leagues_premium()->customizer->get_value( 'match', 'lineups_event_minutes' );
							...
							<div class="d-flex align-items-center ml-auto pl-2">
								...
								if ( ! empty( $events[ $player_id ] ) ) :
									foreach ( $events[ $player_id ] as $evt ) :
										echo $event_icons[ $evt['type'] ] ?? ''; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
