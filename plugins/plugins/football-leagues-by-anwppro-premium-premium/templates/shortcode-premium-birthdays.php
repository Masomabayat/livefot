<?php
/**
 * The Template for displaying Birthdays shortcode
 *
 * This template can be overridden by copying it to yourtheme/anwp-football-leagues/shortcode-premium-birthdays.php.
 *
...
$layout  = 'slim' === $data['layout'] ? 'wide-slim' : 'wide';
?>
<div class="anwp-b-wrap birthdays--shortcode">
	...
	if ( empty( $players ) ) {
		...
		foreach ( $players as $player ) {
			...
			anwp_fl()->load_partial( $player, 'player/player-birthday-card', $layout );
		}
	}
	?>
</div>
