 ...
 *
 * This template can be overridden by copying it to yourtheme/anwp-football-leagues/shortcode-premium-transfers--competition-compact.php.
 *
...
?>
<div class="anwp-b-wrap transfers-list transfers-list--shortcode transfers-list-competition-compact anwp-grid-table anwp-grid-table--aligned anwp-grid-table--bordered anwp-text-xs anwp-border-light">
	...
	<div class="anwp-grid-table__td transfers-list-competition__club-out anwp-bg-light justify-content-start anwp-grid-table__sm-none">
		<?php echo esc_html( AnWPFL_Text::get_value( 'transfers__shortcode__club_out', __( 'Club Out', 'anwp-football-leagues-premium' ) ) ); ?>
	</div>

	<div class="anwp-grid-table__td transfers-list-competition__club-in anwp-bg-light justify-content-start anwp-grid-table__sm-none">
	...
	<?php foreach ( $transfers as $transfer ) : ?>
		<div class="anwp-grid-table__td transfers-list-competition__player d-flex align-items-start anwp-overflow-x-hidden">
			...
			<div class="d-flex flex-column">
				...
				<div class="d-flex align-items-center flex-wrap">
					...
					<?php endif; ?>
					<div class="anwp-opacity-80 mr-2 transfers-list-competition__dob">
		...
		<div class="anwp-grid-table__td transfers-list-competition__club-out justify-content-start anwp-grid-table__sm-none anwp-overflow-x-hidden">
			<?php
			...
			if ( ! empty( $club_link ) && ! empty( $club_logo ) && 2 !== $club_id ) :
				...
				<a href="<?php echo esc_url( $club_link ); ?>" class="anwp-link-without-effects text-decoration-none">
					<img loading="lazy" width="30" height="30" class="anwp-object-contain mr-2 transfers-list-competition__club-out-logo anwp-w-30 anwp-h-30"
		...
		<div class="anwp-grid-table__td transfers-list-competition__club-in justify-content-start anwp-text-center anwp-grid-table__sm-none anwp-overflow-x-hidden">
			<?php
			...
			if ( ! empty( $club_link ) && ! empty( $club_logo ) && 2 !== $club_id ) :
				?>
				<a href="<?php echo esc_url( $club_link ); ?>" class="anwp-link-without-effects text-decoration-none">
					<img loading="lazy" width="30" height="30" class="anwp-object-contain mr-2 transfers-list-competition__club-in-logo anwp-w-30 anwp-h-30"
						data-toggle="anwp-tooltip" data-tippy-content="<?php echo esc_attr( $club_title ); ?>"
						src="<?php echo esc_url( $club_logo ); ?>" alt="<?php echo esc_attr( $club_title ); ?>">
				</a>
				<?php echo esc_attr( $club_title ? : '' ); ?>
