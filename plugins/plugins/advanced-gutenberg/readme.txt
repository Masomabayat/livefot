...
- **[Login & Register block](https://publishpress.com/knowledge-base/login-register-form-block/)**: The PublishPress Login & Register block allows you to load a WordPress login or register form inside Gutenberg. You can also setup a redirect URL after login and customize the design by adding your own logo and colors.
